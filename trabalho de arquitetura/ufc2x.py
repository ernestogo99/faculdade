...
## 18: MAR <- MBR; read_word(MAR); goto 19
firmware[18] = 0b00010011_000_00010100_100000_010_010

## 19: H <- MDR; goto 20
firmware[19] = 0b00010100_000_00010100_000001_000_000

## 20: Y <- H + Y; goto 0
firmware[20] = 0b00000000_000_00111100_000010_000_100

# Y = Y - memory[address]

## 21: PC <- PC + 1; fetch; goto 22
firmware[21] = 0b00010110_000_00110101_001000_001_001

## 22: MAR <- MBR; read; goto 23
firmware[22] = 0b00010111_000_00010100_100000_010_010

## 23: H <- MDR; goto 24
firmware[23] = 0b00011000_000_00010100_000001_000_000

## 24: Y <- Y - H; goto 0
firmware[24] = 0b00000000_000_00111111_000010_000_100

# memory[address] = Y

## 25: PC <- PC + 1; fetch; goto 26
firmware[25] = 0b00011010_000_00110101_001000_001_001

## 26: MAR <- MBR; goto 27
firmware[26] = 0b00011011_000_00010100_100000_000_010

## 27: MDR <- Y; write; goto 0
firmware[27] = 0b00000000_000_00010100_010000_100_100


# if Y == 0 goto address //mudar endereços dps

## 30: Y <- Y; if alu = 0 goto 272 else goto 30
firmware[30] = 0b00011111_001_00010100_000010_000_100

## 31: PC <- PC + 1; goto 0
firmware[31] = 0b00000000_000_00110101_001000_000_001

## 287: goto 13
firmware[287]= 0b00001101_000_00000000_000000_000_000 #vai pra posição 13 pra aproveitar o goto

# X = X * memory[address]

## 38: PC <- PC + 1; fetch; goto 39
firmware[38] = 0b00100111_000_00110101_001000_001_001

## 39: MAR <- MBR; read_word(MAR); goto 40
firmware[39] = 0b00101000_000_00010100_100000_010_010

## 40: H <- MDR; goto 41
firmware[40] = 0b00101001_000_00010100_000001_000_000

##41: y <- 0 goto 42
firmware[41] = 0b00101010_000_00010000_000010_000_100

## 42: x <- x se 0 goto 299,goto 43
firmware[42] = 0b00101011_001_00010100_000100_000_011

## 298: x <- y goto 45
firmware[299] = 0b00101101_000_00010100_000100_000_100

## 43: y <- H + y goto 44
firmware[43] = 0b00101100_000_00111100_000010_000_100

##44: x = x-1 goto 42
firmware[44] = 0b00101010_000_00110110_000100_000_011

##45: y <- 0 goto main
firmware[45] = 0b00000000_000_00010000_000010_000_100
